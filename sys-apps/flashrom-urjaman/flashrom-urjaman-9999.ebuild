...
EGIT_REPO_URI="https://github.com/urjaman/flashrom"
inherit git-r3

DESCRIPTION="Utility for reading, writing, erasing and verifying flash ROM chips"
HOMEPAGE="https://github.com/urjaman/flashrom"
...
IUSE="${IUSE_PROGRAMMERS} +internal_dmi static +wiki"
...
src_prepare() {
	sed -i \
		...
		Makefile || die
	sed -i -e s@https://flashrom.org@$HOMEPAGE@ flashrom.c || die
	sed -i -e 's:r="$r-dirty":true:' util/getrevision.sh || die
}
...
src_compile() {
	...
	args+=("SVNVERSION=$(./util/getrevision.sh -l 2>/dev/null)")
...
src_install() {
	newbin flashrom flashrom-urjaman
	newman flashrom.8 flashrom-urjaman.8
